...
@section('content')
    ...
    <section style="background-color: black;" class="breadcrumb-section set-bg" data-setbg="img/breadcrumb.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="./index.html">{{ $product->productCategory->name }}</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <a href="#" data-product-id="{{ $product->id }}" class="button-add-to-cart primary-btn">ADD TO CARD</a>
