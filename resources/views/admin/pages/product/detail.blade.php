...
<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" method="post" action="{{ route('admin.product.update', ['product' => $product]) }}" enctype="multipart/form-data">
          @csrf
          @method('PATCH')
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input name="price" value="{{ $product->price }}" type="number" class="form-control" id="price" placeholder="Enter price">
            </div>
            @error('price')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            ...
            <div class="form-group">
              ...
              <input name="qty" value="{{ $product->qty }}" type="number" class="form-control" id="qty" placeholder="Enter qty">
            </div>
            @error('qty')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
